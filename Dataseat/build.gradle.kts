...
val libraryArtifactId by extra("dataseat-adapter")
...
dependencies {
    implementation("com.dataseat:dataseatSdk:${libraryVersions["dataseat"]}")
}
        ...
        create<MavenPublication>(extra["publicationName"] as String) {
            ...
            pom.withXml {
                asNode().apply {
                    ...
                    appendNode("description", "Dataseat adapter for AppLovin MAX mediation")
                    ...
                    appendNode("dependencies")
                        .appendNode("dependency").apply {
                            appendNode("groupId", "com.dataseat")
                            appendNode("artifactId", "dataseatSdk")
                            appendNode("version", libraryVersions["dataseat"])
