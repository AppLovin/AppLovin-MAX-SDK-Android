        ...
        implements AppLovinAdLoadListener, AppLovinAdDisplayListener, AppLovinAdViewEventListener, AppLovinAdClickListener
{
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        MRECProgrammaticContentLayout.addView( mrecAdView, new ConstraintLayout.LayoutParams( ViewGroup.LayoutParams.MATCH_PARENT, AppLovinSdkUtils.dpToPx( this, 300 ) ) );
