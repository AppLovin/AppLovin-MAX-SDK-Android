...
val libraryArtifactId by extra("fyber-adapter")
val libraryGroupId by extra("com.applovin.mediation")

var libraryVersions = rootProject.extra["versions"] as Map<*, *>

android.namespace = "com.applovin.mediation.adapters.inneractive"
        ...
        create<MavenPublication>(extra["publicationName"] as String) {
            ...
            pom.withXml {
                asNode().apply {
                    ...
                    appendNode("description", "Fyber adapter for AppLovin MAX mediation")
